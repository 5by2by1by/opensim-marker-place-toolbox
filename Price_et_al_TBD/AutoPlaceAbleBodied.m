...
subjOptions.IKSetup = {'S01_PSF_T06_IK_Settings.xml',...
    'S02_PSF_T01_IK_Settings.xml','S04_PSF_T02_IK_Settings.xml',...
...
subjOptions.fixedMarkerCoords = {{'Sternum x','Sternum y','Sternum z','R.ASIS x','R.ASIS y','R.ASIS z','L.ASIS x','L.ASIS y','L.ASIS z'},...
    {'Sternum x','Sternum y','Sternum z','R.ASIS x','R.ASIS y','R.ASIS z','L.ASIS x','L.ASIS y','L.ASIS z'},{'Sternum x','Sternum y','Sternum z','R.ASIS x','R.ASIS y','R.ASIS z','L.ASIS x','L.ASIS y','L.ASIS z'}...
    {'Sternum x','Sternum y','Sternum z','R.ASIS x','R.ASIS y','R.ASIS z','L.ASIS x','L.ASIS y','L.ASIS z'},{'Sternum x','Sternum y','Sternum z','R.ASIS x','R.ASIS y','R.ASIS z','L.ASIS x','L.ASIS y','L.ASIS z'}...
    {'Sternum x','Sternum y','Sternum z','R.ASIS x','R.ASIS y','R.ASIS z','L.ASIS x','L.ASIS y','L.ASIS z'},{'Sternum x','Sternum y','Sternum z','R.ASIS x','R.ASIS y','R.ASIS z','L.ASIS x','L.ASIS y','L.ASIS z'}...
    {'Sternum x','Sternum y','Sternum z','R.ASIS x','R.ASIS y','R.ASIS z','L.ASIS x','L.ASIS y','L.ASIS z'}};
...
%     options.fileID = fopen(['coarseMarkerSearch_log_' subject '_' prosType '_' char(datetime('now','TimeZone','local','Format','d-MMM-y_HH.mm.ss_Z')) '.txt'], 'w');
    options.fileID = fopen(['coarseMarkerSearch_log_' subject '_' prosType '_10tilt_lockedasis_50conv.txt'], 'w');
%     newName = [subject '_' prosType '_ALLBODY_auto_marker_place_' char(datetime('now','TimeZone','local','Format','d-MMM-y_HH.mm.ss')) '.osim'];
    newName = [subject '_' prosType '_ALLBODY_auto_marker_place_20tilt_lockedasis_50conv.osim'];
